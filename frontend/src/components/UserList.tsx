...
const UserList: React.FC<UserListProps> = ({
  ...
  const loadUsers = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8000/api/admin/users?guild_id=${guildId}`, {
        headers: {
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: 'white' }}>
          <thead>
            <tr style={{ backgroundColor: '#f7fafc' }}>
              ...
              <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #e2e8f0' }}>Phonetic</th>
                ...
                <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>
                  {editingUser === user.id ? (
                    ...
                    <span style={{
                      ...
                      fontSize: '12px',
                      backgroundColor:
                        user.availability === 'online' ? '#c6f6d5' :
                        user.availability === 'away' ? '#fef5e7' : '#f7fafc',
                      color:
                        user.availability === 'online' ? '#276749' :
                        user.availability === 'away' ? '#744210' : '#4a5568'
                    }}>
                      {user.availability}
                    </span>
                  )}
